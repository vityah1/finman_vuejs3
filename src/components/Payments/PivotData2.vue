...
export default {
	...
	methods: {
		createPivotTable() {
			if (this.pivotTable) {
				this.pivotTable.pivotUI(this.payments);
			} else {
				this.pivotTable = $("#pivot-container").pivotUI(this.payments, {
					rows: ["category_name", "mydesc"],
					cols: ["source"],
					vals: ["amount"],
					aggregatorName: "Sum",
					rendererName: "Table",
					...
					// 			// Callback function for table click events
					// 		},
					// 	},
					// },
				});
